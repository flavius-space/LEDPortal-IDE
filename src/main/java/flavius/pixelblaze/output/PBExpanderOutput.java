...
public class PBExpanderOutput extends SerialOutput implements PBConstants {
    ...
    public void addWS281XChannel(int channelNumber, int[] indexBuffer) {
        this.messageFactories.add(0, new PBMessageFactoryWS281X(PBColorOrder.RGB, channelNumber, indexBuffer));
    }

    public void addAPA102DataChannel(int channelNumber, int[] indexBuffer, long freq) {
        this.messageFactories.add(0, new PBMessageFactoryAPA102Data(PBColorOrder.RGBV, channelNumber, indexBuffer, freq));
    }
